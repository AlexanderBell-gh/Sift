          ...
          <div className={`extension-banner${dismissing ? ' dismissing' : ''}`}>
            <div className="container extension-banner-inner">
              ...
              <div className="extension-banner-actions">
                <a href="https://github.com/Alex-Projects-Master/sift-extension/releases/download/v0.2.5/sift-extension-0.2.5-chrome.zip" target="_blank" rel="noopener noreferrer" className="extension-banner-btn">
                  Download
                </a>
              </div>
            </div>
