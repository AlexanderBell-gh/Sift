          ...
          <div className={`extension-banner${dismissing ? ' dismissing' : ''}`}>
            <div className="container extension-banner-inner">
              <div className="extension-banner-text">
                ...
                <span className="extension-banner-desc">Get the official extension required for adding products to your Watchlist</span>
              </div>
              <div className="extension-banner-actions">
                <a href="https://github.com/Alex-Projects-Master/sift-extension/releases/download/v0.2.4/sift-extension-0.2.4-chrome.zip" target="_blank" rel="noopener noreferrer" className="extension-banner-btn">
                  Download
                </a>
              </div>
            </div>
