...
export const STORES: Store[] = [
  ...
  { id: 'morrisons', name: 'Morrisons', logo: '/Morrisons_Logo.svg', searchUrl: (q) => `https://www.morrisons.com/search?q=${encodeURIComponent(q)}`, offersUrl: 'https://www.morrisons.com/offers' },
