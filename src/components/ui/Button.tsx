    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-accent text-white hover:bg-[color-mix(in_oklab,var(--accent)_88%,black)]': variant === 'primary',
            'border border-white/10 bg-white/5 text-zinc-300 hover:bg-white/10': variant === 'secondary',
            'text-red-500 hover:bg-red-500/10 border border-red-500/20 hover:bg-[color-mix(in_oklab,var(--danger)_88%,black)]': variant === 'danger',
